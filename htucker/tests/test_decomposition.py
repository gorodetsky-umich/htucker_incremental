...
class TestDecomposition(unittest.TestCase):
    ...
    def test_hosvd(self):
        ...
        einsum_str = ",".join([core_indices] + matrices_indices) + "->" + "".join([chr(97 + len(self.tensor_4d.shape) + i) for i in range(len(self.tensor_4d.shape))])
    ...
    def test_hosvd_only_for_dimensions(self):
        ...
        matrices = hosvd_only_for_dimensions(self.tensor_4d, tol=self.tol, dims=dims, contract=False)
