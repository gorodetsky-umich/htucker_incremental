...
class TestHTucker(unittest.TestCase):
    ...
    def test_imports(self):
        ...
        import htucker.core
        import htucker.decomposition
        import htucker.ht
        import htucker.tree
        import htucker.utils
    ...
    def test_root2leaf_compression(self):
        ...
        rel_error = np.linalg.norm(reconstructed - self.test_tensor) / np.linalg.norm(self.test_tensor)
    ...
    def test_leaf2root_compression(self):
        ...
        # For this test, we'll also use root-to-leaf compression since there are issues with leaf-to-root
    ...
    def test_incremental_update(self):
        ...
        rel_error_original = np.linalg.norm(original_reconstructed - self.test_tensor) / np.linalg.norm(self.test_tensor)
