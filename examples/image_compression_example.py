...
def main():
    ...
    plt.text(0.5, 0.5, f"Original Size: {img_array.nbytes / 1024:.1f} KB", 
    ...
    print("-" * 80)
    print(f"{'Tolerance':<10} {'Comp. Ratio':<12} {'PSNR (dB)':<12} {'Size (KB)':<12} {'Time (s)':<12}")
    print("-" * 80)
    for res in results:
        print(f"{res['tolerance']:<10.1e} {res['compression_ratio']:<12.2f} {res['psnr']:<12.2f} "
